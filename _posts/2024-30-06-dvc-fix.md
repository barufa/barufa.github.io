...
date: 2024-06-30
category:
tags: machine-learning, data, mlops
---
...
It turns out that DVC struggles with handling a large number of files (>200k)[[1]](https://discuss.dvc.org/t/dvc-with-external-data-is-very-slow/1121)[[2]](https://github.com/iterative/dvc/issues/7607). In our case, it took over 8 hours to upload the data with DVC and another 3 hours to download it. These times were clearly unmanageable for us. Once the download was complete, DVC needed an additional ~1.5 hours to check out the files. The conclusion was clear: we had a huge performance issue!
